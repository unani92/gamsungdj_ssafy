    ...
    <div class="footer-content">
        <div class="row" style="height:100%; align-items:center;">
            <div class="col-12 col-sm-3">
                <img :src="selectedSong.img" style="height:-webkit-fill-available;"> <a class="glyph-icon" style="cursor:pointer;" @click="detailArtist(selectedSong.singerID)">{{ selectedSong.title }}</a> - <a class="glyph-icon" style="cursor:pointer;" @click="detailSong(selectedSong.songID)">{{ selectedSong.artist }}</a>
